...
namespace BarcoSoftUtilidades.Data
{
    public partial class BarcoSoftUtilidadesDB
    {
        ...
        private static string DecryptConnectionString()
        {
            ...
            return String.Format(ConfigurationManager.ConnectionStrings["BarcoSoftDBPrincipal"].ConnectionString.Decrypt(), String.Format("res://*/Data.{0}.csdl|res://*/Data.{0}.ssdl|res://*/Data.{0}.msl", className));
        }
    }
}
