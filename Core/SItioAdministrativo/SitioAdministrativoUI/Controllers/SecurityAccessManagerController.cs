...
namespace SitioAdministrativoUI.Controllers
{
    ...
    public class SecurityAccessManagerController : Controller
    {
        ...
        #region Roles
        [BarcoSoftUtilidades.Seguridad.BarcoSoftAuthorize(Objeto = (int)SitioAdministrativoUI.Accesos.Roles)]
        ...
        public ActionResult Role_Read([DataSourceRequest] DataSourceRequest request)
        {
            ...
            {
                Data = db.Rol.Where(x => x.Activo == true).ToList()
        ...
        {<br>";
                ...
                {
                    resultEnum += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + y.Nombre.Replace(" ", "_") + " = " + y.IdObjeto + ",<br>";
                });
                resultEnum += "}";
        ...
        [BarcoSoftUtilidades.Seguridad.BarcoSoftAuthorize(Objeto = (int)SitioAdministrativoUI.Accesos.Objetos)]
        ...
        #region Encript
        [BarcoSoftUtilidades.Seguridad.BarcoSoftAuthorize(Objeto = (int)SitioAdministrativoUI.Accesos.Encripción)]
        ...
        public ActionResult MenuImages([DataSourceRequest] DataSourceRequest request)
        {
            ...
            foreach (KeyValuePair<string, SitioAdministrativoUI.Controllers.CssParser.StyleClass> s in css.Styles)
            {
